...
## 기능
 ...
 - 네트워크 그래프의 노드는
    ...
    - DB에 등록된 게시글 작성 상태에 따라 완료(초록), 작성 중(노랑), 초안(회색)으로 노드의 색상이 다르게 스타일됩니다.
  
 2. #### 추후
    [프로젝트 작업 보드](https://github.com/users/toa-web-dev/projects/7) 에서 자세히 확인 하실 수 있습니다.
